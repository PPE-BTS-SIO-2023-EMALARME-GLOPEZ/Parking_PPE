<div class="w-1/2 xl:w-1/3 h-fit bg-white rounded-xl">
    ...
    <div class="w-full h-fit flex flex-row justify-center py-5">
        <button type="button" class="w-fit px-2 py-1 bg-timberwolf text-black rounded-lg" @@click="validerSuppressionPlace = false">
            Annuler
        </button>
        <button type="submit" form="" x-ref="supprimer_place_btn" class="w-fit px-2 py-1 mx-5 bg-coquelicot/80 text-black rounded-lg">
            Confirmer
        </button>
